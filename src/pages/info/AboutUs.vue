...
<h1>About me</h1>
<div>
    <p>I am a newbie web developer based in northern Spain.</p>
    ...
    Said classes taught me all the basics in Java with a particularly amazing teacher, then those same basics again in PHP plus some SASS with less amazing teachers 
...
.image{
    ...
    height: 80vh;
    width: 40.5vw;
    background-image: url('./../../assets/probablynotme.jpg');
